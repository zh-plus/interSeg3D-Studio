    ...
    <v-card>
      ...
      <v-card-text>
        <v-list dense>
          ...
          <v-list-item>
            <v-list-item-icon>
              <v-icon color="red">mdi-target</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title>Point Selection</v-list-item-title>
              <v-list-item-subtitle>Click on the position from the list and then click on the point cloud to mark points
                for that object</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
