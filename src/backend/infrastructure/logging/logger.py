...
logger = logging.getLogger("pinpoint3d")
...
file_handler = logging.FileHandler(logs_dir / f"pinpoint3d_{current_date}.log")
...
def get_logger(name=None):
    ...
    If name is None, returns the main pinpoint3d logger.
    """
    if name is None:
        return logger
    return logging.getLogger(f"pinpoint3d.{name}")
